...
// http://answers.unity.com/answers/1296574/view.html
public class ScreenRecorder : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        captureScreenshot |= Keyboard.current[Key.K].wasPressedThisFrame;
        captureVideo = Keyboard.current[Key.V].isPressed;
